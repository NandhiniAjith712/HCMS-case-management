...
const { upload, ticketAttachmentsUpload, handleUploadError } = require('../../shared/middleware/upload');
...
const wsInstanceStore = require('../services/websocket-instance');
...
// Knowledge Base module archived - knowledge.js moved to archive
...
// Knowledge Base module archived - function commented out
...
const getReferenceResolutionRecommendations = async ({ tenantId, ticketId, maxItems = 5 }) => {
  ...
  // Knowledge Base module archived - knowledge base scoring commented out
...
router.put('/:id/resolution-details', authenticateToken, verifyTenantAccess, upload.single('resolution_attachment'), handleUploadError, async (req, res) => {
  try {
    ...
    // Knowledge Base module archived - knowledge sync commented out
