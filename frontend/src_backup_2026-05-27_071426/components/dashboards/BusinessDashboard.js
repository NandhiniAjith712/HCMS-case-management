...
const BusinessDashboard = () => {
  ...
  const handleAddTenant = async (e) => {
    ...
    try {
      ...
      const data = await response.json();
      if (data.success) {
        setNewTenant({ name:'', subdomain:'', plan:'free', max_users:10, max_tickets_per_month:100, whatsapp_enabled:false, email_enabled:true, ceo_name:'', ceo_email:'', ceo_phone:'' });
                ...
                <form onSubmit={handleAddTenant}>
                  ...
                  <div className="bd-form-row">
                    ...
                    <div className="bd-form-group">
                      ...
                      <input type="text" value={newTenant.ceo_name} onChange={(e) => setNewTenant({ ...newTenant, ceo_name: e.target.value })} required />
                    </div>
                  </div>
                  <div className="bd-form-row">
                    <div className="bd-form-group">
                      <label>CEO Email</label>
                      <input type="email" value={newTenant.ceo_email} onChange={(e) => setNewTenant({ ...newTenant, ceo_email: e.target.value })} required />
                    </div>
                    <div className="bd-form-group">
                      <label>CEO Phone</label>
                      <input type="tel" value={newTenant.ceo_phone} onChange={(e) => setNewTenant({ ...newTenant, ceo_phone: e.target.value })} />
                    </div>
                  </div>
